...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'BuildV1.0.data';
    var REMOTE_PACKAGE_BASE = 'BuildV1.0.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 16661178;
      var PACKAGE_UUID = 'e74c845b-85a2-483f-9df6-98abec98ce0c';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 13866539, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(13866539, 13866677, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(13866677, 13870253, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(13870253, 15758581, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(15758581, 16633553, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(16633553, 16661178, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_BuildV1.0.data');

    };
    Module['addRunDependency']('datafile_BuildV1.0.data');
